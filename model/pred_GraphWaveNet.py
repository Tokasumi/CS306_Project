...
parser.add_argument("--flowpath", type=str, default='../demo_data/2019-2020-graph-outflow.npz', help="../data-NYCBike/60min/bike-timestamp-outflow.h5;----   ../data-NYCTaxi/60min/taxi-timestamp-inflow.h5")
parser.add_argument("--adjpath", type=str, default='../demo_data/W_adj_matrix.csv', help="data-ShenZhenZones/W_adj_matrix.csv")
